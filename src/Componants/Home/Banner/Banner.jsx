...
const Banner = () => {
    ...
    return (
        <div>
            ...
            <div className="carousel lg:h-[600px] max-sm:h-[300px] max-sm:mt-24 max-sm:pb-12 w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="  absolute flex lg:items-center bg-gradient-to-r from-indigo-500 via-[#ea1043e1] to-[rgba(21, 21, 21, 0)] h-full w-full justify-center">
                        ...
                        <div className=" space-y-5 max-sm:pl-8 max-sm:w-4/5 text-white max-sm:space-y-2 lg:space-y-7  md:w-full"
                            data-aos="zoom-in-down"
                            data-aos-duration="2000"
                            data-aos-delay="500">
                            <div className='max-w-6xl mx-auto max-sm:mt-10'>

                                <h1 className="max-sm:text-base md:text-4xl lg:text-5xl font-bold text-white">Best Phone collection<br /> Staring</h1>
                                <p className="max-sm:text-xs max-sm:mt-2 max-sm:mb-2 mt-7 mb-7 text-[#fff] text-base">There are many variations of passages of  available, <br /> but the majority have suffered alteration in some form</p>
                    ...
                    <div className="  absolute flex lg:items-center  bg-gradient-to-r from-indigo-500 via-[#ea1043e1] to-[rgba(21, 21, 21, 0)] h-full w-full justify-center">
                        ...
                        <div className=" space-y-5 max-sm:pl-8 max-sm:w-4/5 text-white max-sm:space-y-2 lg:space-y-7  md:w-full"
                            ...
                            <div className='max-w-6xl mx-auto max-sm:mt-10'>
                                ...
                                <h1 className="max-sm:text-base md:text-4xl lg:text-5xl font-bold text-white">Affordable Price For <br /> Car Servicing</h1>
                                <p className="max-sm:text-xs max-sm:mt-2 max-sm:mb-2 mt-7 mb-7 text-[#fff] text-base">There are many variations of passages of  available, <br /> but the majority have suffered alteration in some form</p>
                                <button className="btn btn-slide-left px-8 py-3 max-sm:px-2 max-sm:py-1 rounded-full">Discover More</button>
                            </div>
                        </div>
