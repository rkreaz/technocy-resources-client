        ...
        <div className='theme'>
            <div className="max-w-6xl mx-auto pt-14">
                <footer className="footer theme_text mx-auto max-sm:text-center">
                    <nav>
                        <h6 className="footer-title hover:text-[#F02757] hover:underline cursor-pointer">COMPANY</h6>
                    ...
                    <nav>
                        <h6 className="footer-title hover:text-[#F02757] hover:underline cursor-pointer">SHOP</h6>
                    ...
                    <nav>
                        <h6 className="footer-title hover:text-[#F02757] hover:underline cursor-pointer">HELP</h6>
                    ...
                    <nav>
                        <h6 className="footer-title hover:text-[#F02757] hover:underline cursor-pointer">MY ACCOUNT</h6>
